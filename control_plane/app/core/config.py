...
class Settings(BaseSettings):
    ...
    sandbox_host_passthrough_enabled: bool = Field(default=False)
    sandbox_host_passthrough_mount_root: str = Field(default="/workspace/chal/_host")
    sandbox_host_passthrough_max_dirs: int = Field(default=4)
